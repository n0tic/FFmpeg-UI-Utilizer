...
{
    [Serializable]
    public class NormalizeAudioArguments
    {
        ...
        public NormalizeAudioArguments(Libs.Overwrite _overwrite, FileInfo inputFile, Libs.VCodec vC, Libs.ACodec aC, Libs.Tune _tuner, Libs.Preset _preset, Libs.Frames frames, Libs.Size res, string outputDir, string fileName, Libs.VideoFileExtensions fileExt)
        {
